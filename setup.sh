...
#install webmin
cd
wget -O /etc/apt/sources.list "https://raw.githubusercontent.com/Natch0141/ubuntu/main/source.list"
...
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/Natch0141/ubuntu/main/squid.conf"
